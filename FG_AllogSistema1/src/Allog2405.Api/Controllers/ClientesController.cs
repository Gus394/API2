...
public class CustomersController : MainController {
    ...
    public CustomersController(CustomerData data, IMapper mapper, CustomerContext context) // ?
    {
    ...
    {
        var customerFromDatabase = _context.Customers.OrderBy(c => c.firstName.ToList());
        var customersToReturn = _mapper.Map<IEnumerable<CustomerDTO>>(customerFromDatabase);
        return Ok(customersToReturn);
    }

    [HttpGet("{id}", Name = "GetCustomerPorId")]
    ...
    public ActionResult PartiallyUpdateCustomer(
        ...
        [FromRoute] int id)
        {
            ...
            patchDocument.ApplyTo(customerToPatch, ModelState); // model state verifica as propriedades de uma forma porca
